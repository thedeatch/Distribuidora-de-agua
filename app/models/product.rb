class Product < ApplicationRecord
  ...
  validates :liters, presence:{ message: "no puede estar en blanco" }, numericality: { message: "no es un numero" }, length: { in: 1..4 , :message => "La cantidad de litros no debe superar las 4 cifras"}, uniqueness: { message: "Producto ya existe" }
